...
namespace Movies
{
    ...
    public static class MovieDatabase
    {
       ...
       /* public List<Movie> SearchAndFilter(List<Movie> movies, string term)
        {
            ...
            foreach(Movie movie in movies)
            {
                ...
                {
                    if(movie.Title != null && movie.Title != null && movie.Title.Contains(searchString, StringComparison.InvariantCultureIgnoreCase))
                    {
                        results.Add(movie);
                    }
                }
